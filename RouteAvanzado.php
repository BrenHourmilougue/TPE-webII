<?php
    ...
    $r->addRoute("categoria", "GET", "CategoriasController", "HomeCategorias");
    $r->addRoute("filterCategoria", "POST", "ProductsController", "FilterProductsByCategoria");
    ...
    $r->addRoute("editCategoria/:ID", "GET", "CategoriasController", "EditCategoria");
    $r->addRoute("updateCategoria/:ID", "POST", "CategoriasController", "UpdateCategoria");
    //ADMIN USER
